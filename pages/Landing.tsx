    ...
    <div className="bg-slate-50">
      ...
      <div className="py-16 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative rounded-xl overflow-hidden shadow-2xl border-4 border-white max-w-5xl mx-auto bg-slate-200">
            <img 
              src="/before-after.jpg" 
              alt="Before and After Transformation" 
              className="w-full h-auto object-cover"
              onError={(e) => {
                  // Fallback visual if the file isn't uploaded yet
                  e.currentTarget.style.display = 'none';
                  e.currentTarget.parentElement?.classList.add('h-64', 'flex', 'items-center', 'justify-center');
                  const span = document.createElement('span');
                  span.className = 'text-slate-500 font-medium px-4';
                  span.innerText = 'Upload "before-after.jpg" to your public folder to see the image here.';
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="relative mb-10 group">
              ...
              <img 
                ...
                onError={(e) => {
                  // Fallback to a branded monogram if the image fails to load.
                  e.currentTarget.src = "https://ui-avatars.com/api/?name=Chasity+Willis&background=0a192f&color=c19a6b&size=512"; 
